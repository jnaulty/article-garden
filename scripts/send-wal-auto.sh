...
# Script to automatically send WAL tokens to a recipient address (no confirmation)
# Usage: ./send-wal-auto.sh [recipient_address]
...
echo -e "${BLUE}=== WAL Token Auto-Transfer Script ===${NC}\n"
...
# Transfer each WAL token (no confirmation)
TRANSFER_COUNT=0
SUCCESS_COUNT=0
FAILED_COUNT=0
